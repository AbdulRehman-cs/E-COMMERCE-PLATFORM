...
$subcategoryId = $_GET['id']; // Assuming the subcategory ID is passed via a GET request
$subcategory = $categoryManager->getSubcategoryById($subcategoryId); // Fetch subcategory details

// Get the records per page and current page
...
$products = $categoryManager->getProductsBySubcategoryId($subcategoryId, $recordsPerPage, $offset);

// Get total number of products for pagination
$totalProducts = $categoryManager->getTotalProductsBySubcategoryId($subcategoryId);
...
<?php
$imagePath = 'subcategory/' . urlencode($subcategory['Image']) . '.jpg'; // Adjust path for subcategory images
$defaultImagePath = 'subcategory/default.jpg'; // Path to a default image
...
?>
<div class="container-fluid bg-primary py-5 mb-5 page-header" style="background-image: url('category/<?php echo $subcategory['Image']; ?>'); background-size: cover; background-position: center; position: relative;">
  ...
  <div class="container py-5 position-relative z-index-1">
    <div class="row justify-content-center">
      <div class="col-lg-10 text-center">
        <h1 class="display-3 text-white animated slideInDown"><?=$subcategory ? htmlspecialchars($subcategory['Subcategory_Name']) : 'Subcategory Not Found'; ?></h1>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center">
            <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
            <li class="breadcrumb-item"><a class="text-white" href="#">Subcategory</a></li>
            <li class="breadcrumb-item text-white active" aria-current="page"><?=$subcategory ? htmlspecialchars($subcategory['Subcategory_Name']) : 'Subcategory Not Found'; ?></li>
          </ol>
        </nav>
      </div>
    </div>
