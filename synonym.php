...
$synonymId = $_GET['id']; // Assuming the synonym ID is passed via a GET request
$synonym = $categoryManager->getSynonymById($synonymId); // Fetch synonym details
...
// Fetch products by synonym ID
$products = $categoryManager->getProductsBySynonymId($synonymId, $recordsPerPage, $offset);

// Get total number of products for pagination
$totalProducts = $categoryManager->getTotalProductsBySynonymId($synonymId);
...
<?php
$defaultImagePath = 'synonym/default.jpg'; // Path to a default image

// Check if the image exists

?>
<div class="container-fluid bg-primary py-5 mb-5 page-header" style="background-image: url('synonym/<?php echo $synonym['Image']; ?>'); background-size: cover; background-position: center; position: relative;">
  ...
  <div class="container py-5 position-relative z-index-1">
    <div class="row justify-content-center">
      <div class="col-lg-10 text-center">
        <h1 class="display-3 text-white animated slideInDown"><?=$synonym ? htmlspecialchars($synonym['Synonym_Name']) : 'Synonym Not Found'; ?></h1>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center">
            <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
            <li class="breadcrumb-item"><a class="text-white" href="#">Synonym</a></li>
            <li class="breadcrumb-item text-white active" aria-current="page"><?=$synonym ? htmlspecialchars($synonym['Synonym_Name']) : 'Synonym Not Found'; ?></li>
          </ol>
        </nav>
      </div>
    </div>
...
<?php
echo $imagePath = 'category/' . urlencode($category['Image']) . '.jpg';
...
<?include 'footer.php'?> <div class="container-fluid">
    <div class="row justify-content-center">
